...
export default function ArmDistanceHorizontalReport(props){
    ...
    return (
        ...
        <div style={{backgroundColor:"white"}}>
         <h5 style={{color:'black'}}>{props.paragraph.replaceAll("_",".") + " Κάμψη βραχίονα στο οριζόντιο επίπεδο"}</h5>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr"}}>
 
            <div style={{padding:"1rem",border:"2px solid black",margin:"1rem"}}>

                <p style={{color:'black'}}><b>Μέτρηση: </b>{props.inspection.measurements[props.paragraph].value}</p>
