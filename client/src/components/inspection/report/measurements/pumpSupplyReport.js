...
export default function PumpSupplyReport(props){
    ...
    return (
        ...
        <div style={{backgroundColor:"white"}}>
         <h5 style={{color:'black'}}>{props.paragraph.replaceAll("_",".") + " Ανάλυση ικανότητας παροχής αντλίας με μανόμετρο αναφοράς σε ακραίο ακροφύσιο"}</h5>
