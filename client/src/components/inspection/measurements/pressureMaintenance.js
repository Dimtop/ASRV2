...
export default function PressureMaintenance(props){
    ...
    return(
        <>
            ...
            <Panel bordered header={props.paragraph.replaceAll("_",".")  + " Διατήρηση σταθερής πίεσης σε σταθερή ρύθμιση"} className="withMargin">
                <p>Μ.Ο. Μετρήσεων</p>
