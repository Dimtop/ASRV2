...
export default function PressureMaintenanceUponStop(props){
    ...
    return(
        <>
            ...
            <Panel bordered header={props.paragraph.replaceAll("_",".") + " Αντισταθμιστικές επιστροφές (διατήρηση πίεσης κατόπιν παύσης)"} className="withMargin">
                <Grid fluid>
                    <Row>
                        {
                            props.sprayer.branches.map((branch,branchIndex)=>{
                                return(
                                    <Col xs={24} md={8}>
                                        <p>{"Μέτρηση με κλάδο " + (branchIndex+1).toString() + " κλειστό"}</p>
